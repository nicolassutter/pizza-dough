...
const themeOptions: { value: Theme; label: string; icon: React.ReactNode }[] = [
  ...
  { value: 'system', label: 'System', icon: <MonitorIcon className="w-5 h-5" /> },
];
...
export const ThemeDropdown: React.FC = () => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-48 rounded-lg border-2 border-cyber-border-light dark:border-cyber-border-dark 
